           <div class="links-container">
                    <ul>
                        <li class="personal-info"><a href="employeeDetails.php?a=<?php echo $b; ?>">Personal Details</a>
                        </li>
                        <li class="Contact-Details"><a href="contactDetails.php?a=<?php echo $b; ?>">Contact Details</a>
                        </li>
                        ...
                        <li class="Qualifications"><a href="qualification.php?a=<?php echo $b; ?>">Qualifications</a></li>
                        <li class="Memberships"><a href="membership.php?a=<?php echo $b; ?>">Memberships</a></li>
                    </ul>
        </div>
